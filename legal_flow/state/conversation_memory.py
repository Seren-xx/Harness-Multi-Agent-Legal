"""对话记忆：基于Redis的对话记忆管理器。
1. import config → from legal_flow import config（v2 自包含）
2. compress_history 的摘要模型 zhipuai → dashscope（v2 主模型）
"""
import json
...
摘要："""
        ...
        try:
            summary = llm_callback([{"role": "user", "content": prompt}], model="dashscope")
